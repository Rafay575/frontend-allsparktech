                ...
                <div className="flex flex-wrap mt-[50px] gap-y-[50px]">
                    {serviceProcess.process.map((process, index) => (
                        <motion.div
                            ...
                            <Image src={`${baseURL}/images/services/${process.image}`} alt='img1' width={450}  loading="lazy" unoptimized

                                 

                                height={450} className='w-[130px]' />
                            {process.dir &&
                                <Image src={`${baseURL}/images/services/${process.dir}`} width={400} height={400} alt='img1' className='absolute w-[60px] hidden xl:block xl:w-[80px] -right-[10%] top-[12%]'  loading="lazy" unoptimized
