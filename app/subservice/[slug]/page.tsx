        ...
        <>
            ...
            <section
                ...
                <div className="container flex flex-col justify-center items-center h-full">
                    <p className='text-white text-[30px] lg:text-[40px] font-bold'>
            ...
            <div className='flex flex-col gap-y-[100px]  lg:gap-y-[150px]  my-[70px]'>
                ...
                <div className="container">
                    <div className="mb-[30px]">
                        <p className=' w-full lg:w-[65%] font-bold text-[30px] text-[#1F2937] lg:text-[35px]  lg:leading-[40px]'>
                ...
                <div className='container flex flex-col lg:flex-row '>
                    <div className='flex flex-col gap-[30px] w-full lg:w-[50%]'>
                        <p className='font-bold text-[30px] lg:text-[35px] text-[#1F2937]  lg:leading-[40px]'>
                ...
                {/* Section 4  */}
                <div className="container">
                    <p className=' w-full lg:w-[65%] font-bold text-[30px] lg:text-[35px]  lg:leading-[40px] text-[#1F2937]'>{subServiceJson.section4.title}</p>
                    <p className='w-full lg:w-[65%] text-[15px] text-[#6f798b] mt-[20px]'>{subServiceJson.section4.des}</p>
                </div>

                {/* Section 5  */}
                <div className='bg-[#0D0B52]'>
                    <div className="container py-[50px] lg:py-[100px]">
                        <p className='font-bold text-[30px] lg:text-[35px]  lg:leading-[40px] text-white w-full lg:w-[70%] mx-auto lg:mx-[0]'>{subServiceJson.section5.title}</p>
                        <div className='flex flex-col lg:flex-row gap-x-[80px] items-center lg:items-start gap-y-[30px] lg:gap-y-0 mt-[40px]'>
                            {
                                subServiceJson.section5.steps.map((item: any, index: number) => (
                                    <div key={index} className={`grow w-[90%] lg:w-1/4  xl:px-[20px] steps`} style={{ marginTop: item.margin }}>
                                        ...
                                        <p className='text-white font-semibold text-[25px]'>{item.title}</p>
                                        <p className='text-[15px] text-[white] mt-[10px]'>{item.description}</p>
                                    </div>
                                ))
                            }
                        </div>
                ...
                <div className='container flex flex-col lg:flex-row '>
                    <div className='flex flex-col gap-[30px] w-full lg:w-[50%]'>
                        <p className='font-bold text-[30px] text-[#1F2937]  lg:text-[35px]  lg:leading-[40px]  '>{subServiceJson.section6.title}</p>
                        <div>
                            <p className="text-[15px] text-[#6f798b]">{subServiceJson.section6.des}
                            </p>
                            <p className="text-[15px] text-[#6f798b] mt-[15px]">{subServiceJson.section6.des2}
                            </p>
                        </div>
                ...
                <div className="container border-l-[6px] border-blue-700 pl-[10px]">
                    <p className='w-full lg:w-[65%] font-extrabold text-[25px] lg:text-[30px]  lg:leading-[40px] text-[#1F2937] '>{subServiceJson.section7.quote} </p>
                    <p className='text-[15px] text-[#6f798b] mt-[10px]'>{subServiceJson.section7.author} </p>
                </div>

                {/* Section8  */}
                <div className='bg-[#0D0B52] py-[80px] lg:py-[100px] text-white'>
                    <div className='container flex flex-col lg:flex-row  '>
                        <div className='flex flex-col gap-[30px] w-full lg:w-[50%]'>
                            <p className='font-bold text-[30px] lg:text-[35px] text-white lg:leading-[40px]'>{subServiceJson.section8.title}</p>
                            {subServiceJson.section8.data.map((item: any, index: number) => (
                                <div key={index} >
                                    <h3 className="font-semibold text-[24px] text-white">{item.title}</h3>
                                    <div className="-mt-3">
                                        <div className="w-10 border-b-4 border-blue-500 inline-block"></div>
                                    </div>
                                    <p className="text-[15px] text-white">{item.description}</p>
                                </div>
                            ))}
                        </div>
                        <div className='w-full lg:w-[50%] lg:pl-[20px] lg:pl-[40px] '>
                ...
                {/* Section9  */}
                <div className='container'>
                    <p className='font-bold text-[30px] lg:text-[35px] text-[#1F2937] lg:leading-[40px] text-center'>{subServiceJson.section9.title}</p>
                    <p className="text-[15px] text-[#6f798b] mt-[10px] text-center">{subServiceJson.section9.para}</p>
                    <div className="flex gap-[10px] mt-[20px] justify-center flex-wrap w-[90%] lg:w-[80%] mx-auto">
                        {subServiceJson.section9.industries.map((ind: any, index: number) => (
                            <p key={index} className='bg-[#384BFF] px-[15px] py-[7px] text-white rounded-[4px] font-[600] text-center '>{ind}</p>
                        ))}
                    </div>
                </div>
                ...
                {/* Faq  */}
                <div className="container ">
                    <p className='font-bold text-[30px] lg:text-[35px]  lg:leading-[40px] mb-[20px] text-[#1F2937]'>
